...
if (match) {
  ...
  fs.writeFileSync('server/migrations/product_attributes.json', JSON.stringify(attributes, null, 2))
  console.log('Extracted attributes to server/migrations/product_attributes.json')
} else {
