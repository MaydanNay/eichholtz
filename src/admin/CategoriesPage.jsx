                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    {item.depth === 0 ? (
                      <button 
                        ...
                        style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: '0.25rem', color: '#666' }}
                        aria-label="Раскрыть"
                      >
                    ...
                    {item.children && item.children.length > 0 && (
                      <span style={{ color: '#999', fontSize: '0.85rem' }}>({item.children.length})</span>
                    )}
                  </div>
                </td>
