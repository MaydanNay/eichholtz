...
export default function ProductsPage() {
  ...
  const load = async () => {
    try {
      const [productsData, categoriesData, collectionsData, catalogsData] = await Promise.all([
        api.getProducts(),
        api.getCategories(),
      ...
      {showForm && (
        <form className="admin-form" onSubmit={handleSubmit}>
          ...
          <div className="admin-form__grid">
            ...
            <label className="admin-field">
              <span>Отделка</span>
              <input value={form.variation} onChange={(e) => setForm({ ...form, variation: e.target.value })} placeholder="Stone finish" />
            </label>
            <label className="admin-field">
              <span>Материал</span>
