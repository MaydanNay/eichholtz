      ...
      <div className="checkout-modal" role="dialog" aria-labelledby="checkout-modal-title">
        ...
        {sent ? (
          <div className="checkout-modal__success modal__success">
            ...
            <p className="modal__success-sub">Менеджер свяжется с вами для уточнения деталей заказа</p>
          ...
          <div className="checkout-modal__layout">
            ...
            <div className="checkout-modal__products-col">
              ...
              {activeItem && activeDetails && (() => {
                const galleryImages = Array.isArray(activeDetails.images) && activeDetails.images.length > 0
                  ? activeDetails.images.filter(Boolean)
                  : activeDetails.image_url ? [activeDetails.image_url] : []
