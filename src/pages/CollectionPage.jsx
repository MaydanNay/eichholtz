    ...
    <div className="collection-page">
      <Reveal className="collection-page__hero" variant="blur-up">
        ...
        <div className="collection-page__hero-content">
          ...
          <h1 className="collection-page__title" style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
            {collection.name}
            {collection.is_new && (
              <span style={{ background: '#b78b5e', color: '#fff', fontSize: '1rem', padding: '4px 12px', borderRadius: '0', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 500 }}>Новинка</span>
            )}
          </h1>
      ...
      {isCategory && (
        <section className="catalogs" style={{ paddingTop: '4rem', paddingBottom: '2rem', borderTop: '1px solid var(--color-gray)' }}>
          ...
          {collectionCatalogs.length > 0 ? (
            ...
            <p className="catalogs__empty" style={{ textAlign: 'center', color: 'var(--color-gray-text)' }}>
